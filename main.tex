...
\setup{
	title={Samenvatting IT en RECHT 2017-2018},
  author={Filip Vanden Eynde \and R0363898 \and 3TX/1},
  teacher={Jan-Pieter Everts},
  company={UCLL Leuven-Limburg},
  location={Haasrode, Leuven, België},
  textsubject={Samenvatting voor het vak IT en RECHT in het academiejaar 2017-2018 voor de Professionele Bachelor
  Toegepaste Informatica},
  keywordspdf={Samenvatting, IT en Recht, Filip Vanden Eynde, schooljaar 2017-2018, UCLL}
  }
...
%\import{./}{acronyms.tex}
%\import{glossary}
\include{sociaalrecht/hfdst1/hoofdstuk1acronyms}
\include{sociaalrecht/hfdst1/hoofdstuk1glossary}
\include{sociaalrecht/hfdst2/hoofdstuk2acronyms}
\include{sociaalrecht/hfdst2/hoofdstuk2glossary}
\include{sociaalrecht/hfdst3/hoofdstuk3acronyms}
\include{sociaalrecht/hfdst3/hoofdstuk3glossary}
\include{sociaalrecht/hfdst4/hoofdstuk4acronyms}
\include{sociaalrecht/hfdst4/hoofdstuk4glossary}
\include{sociaalrecht/hfdst5/hoofdstuk5acronyms}
\include{sociaalrecht/hfdst5/hoofdstuk5glossary}
\include{sociaalrecht/hfdst6/hoofdstuk6acronyms}
\include{sociaalrecht/hfdst6/hoofdstuk6glossary}
\include{sociaalrecht/hfdst7/hoofdstuk7acronyms}
\include{sociaalrecht/hfdst7/hoofdstuk7glossary}

\usepackage{sty/renewcommandsfilip}
...
\makeatletter
\newcommand\subparagraphsection{\@startsection{subparagraph}{4}{\z@}%
...
%Dit zorgt ervoor dat alleen de links blijven werken in de inhoudsopgave maar de kleur blijft zwart voor alle links in alleen de inhoudsopgave. 
\begingroup
...
\include{sociaalrecht/hfdst1/hoofdstuk1}
\include{sociaalrecht/hfdst2/hoofdstuk2}
\include{sociaalrecht/hfdst3/hoofdstuk3}
\include{sociaalrecht/hfdst4/hoofdstuk4}
\include{sociaalrecht/hfdst5/hoofdstuk5}
\include{sociaalrecht/hfdst6/hoofdstuk6}
\include{sociaalrecht/hfdst7/hoofdstuk7}
...
%Dit toont alle glossaries, zelfs degene die niet worden gebruikt als referentie
\glsaddall
%\printglossaries
